...
constexpr inline bool operator==(uint128 lhs, uint128 rhs) {
...
inline constexpr uint128 operator-(uint128 val) {
...
inline constexpr bool operator!(uint128 val) {
...
inline constexpr uint128 operator<<(uint128 lhs, int amount) {
